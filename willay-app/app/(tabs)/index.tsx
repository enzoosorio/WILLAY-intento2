...
const styles = StyleSheet.create({
  ...
  greeting:   { color: colors.text, fontSize: 30, fontWeight: "900" },
  ...
  alertBtnText: { color: "white", fontSize: 24, fontWeight: "900", letterSpacing: 0.5 },
  sentBadge: {
    flexDirection: "row", alignItems: "center", gap: 6, alignSelf: "center",
    backgroundColor: colors.surface, paddingHorizontal: 16, paddingVertical: 8,
    borderRadius: 999, borderWidth: 1, borderColor: colors.success, marginBottom: 16,
  },
  sentText: { color: colors.success, fontSize: 13, fontWeight: "600" },
  sectionTitle: { color: colors.brand, fontSize: 20, fontWeight: "800", marginBottom: 16, marginTop: 4 },
  ...
  botBtnLeft:  { flexDirection: "row", alignItems: "center", gap: 12 },
  botIcon: {
    width: 40, height: 40, borderRadius: 20,
    backgroundColor: colors.brand, alignItems: "center", justifyContent: "center",
  },
  botBtnTitle: { color: colors.text, fontSize: 15, fontWeight: "700" },
  botBtnSub:   { color: colors.textMuted, fontSize: 12 },
  scroll: {
